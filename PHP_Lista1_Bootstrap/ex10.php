    ...
    <div class="container mt-2">
        ...
        <form action="ex10resp.php" method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="peso" class="form-control" id="peso" aria-describedby="peso">
                <label for="altura" class="form-label">Informe a Altura (cm):</label>
                <input type="text" name="altura" class="form-control" id="altura" aria-describedby="altura">
            </div>
