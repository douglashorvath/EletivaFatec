...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="ex7.php">Ex.7</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-2">
        <h3>Exercício 07</h3>
        <h5>Faça um programa em PHP no qual leia um valor em metros e o converta em centímetros</h5>
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="border border-2 rounded border-danger mt-2 col-md-auto mt-2 mb-2 pt-1 pb-1">
                    ...
                    if (isset($_POST['numero']) && $_POST['numero'] != "") {
                        ...
                        $centimetros = metrosParaCentimetros($numero);
                        echo "<h5>$numero metros são $centimetros centrimetros. </h5>";
                    } else {
