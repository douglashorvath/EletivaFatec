            ...
            <div class="row justify-content-md-center">
                ...
                <div class="border border-2 rounded border-danger mt-2 col-md-auto mt-2 mb-2 pt-1 pb-1">
                    ...
                    if (isset($_POST['metros']) && $_POST['metros'] != "") {
                        $metros = $_POST['metros'];
                        $litros = calculaLitros($metros);
                        $latas = calculaLatas($litros);
                        $custo = calculaPreco($latas);
                        echo "<h5>Serão necessárias $latas lata(s) para seu projeto. O Custo total é de R$ $custo</h5>";
                    } else {
