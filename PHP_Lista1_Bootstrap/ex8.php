...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="ex8.php">Ex.8</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container mt-2">
        <h3>Exercício 08</h3>
        <h5>Faça um programa em PHO para uma loja de tintas. O programa deverá pedir o tamanho em metros
            ...
            quantidades de latas de tinta a serem compradas e o preço total</h5>
        <form action="ex8resp.php" method="POST">
            <div class="mb-3">
                <label for="metros" class="form-label">Informe o tamanho, em mestros quadrados, da área a ser pintada:</label>
                <input type="text" name="metros" class="form-control" id="metros" aria-describedby="metros">
            </div>
