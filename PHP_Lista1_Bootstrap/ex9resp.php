            ...
            <div class="row justify-content-md-center">
                ...
                <div class="border border-2 rounded border-danger mt-2 col-md-auto mt-2 mb-2 pt-1 pb-1">
                    ...
                    if (isset($_POST['ano']) && $_POST['ano'] != "") {
                        ...
                        $idade = idadeAnos($anoNascimento);
                        $dias = idadeDias($anoNascimento);
                        $idade2025 = idadeAnos2025($anoNascimento);
                        echo "<h5> Idade: $idade</h5>";
                        echo "<h5> Dias Vividos: $dias </h5>";
                        echo "<h5> Idade em 2025: $idade2025 </h5>";
                    } else {
